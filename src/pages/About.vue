<template>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div class="p-8">
            ...
            <p class="">
              <span>Chief Executive Officer, Founder and Director</span>
            </p>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div class="p-8">
            ...
            <p class="">
              <span>Chief Technology Officer, Co-Founder and Director</span>
            </p>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div class="p-8">
            ...
            <p class="">
              <span>Vice President, Digital Services</span>
            </p>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div class="p-8">
            ...
            <p class="">
              <span>Vice President, Enterprise Business Services</span>
            </p>
          </div>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
          ...
          <div class="p-8">
            ...
            <p class="">
              <span>Vice President, Government Sector</span>
            </p>
          </div>
        </div>
  ...
  <section class="py-40 partnering">
    <div class="container mx-auto">
      <div class="mb-12 text-center">
        <h4>Partnering With Visionaries Across Continents</h4>
      </div>
    </div>
  </section><!--partnering-->
...
.btn {
  ...
  gap: 8px;
  border-radius: 55px;
  background: var(--Rich-Black, #121212);
  color: #FFF;
  font-size: 18px;
  font-weight: 400;
  line-height: 30px;
