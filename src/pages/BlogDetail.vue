<template>
	<section class="w-full bg-white py-16 pt-50 blogdetail-page">
		<div class="max-w-4xl mx-auto">
			...
			<div class="max-w-3xl mx-auto">
				...
				<div class="flex flex-wrap items-center gap-4 mb-2 justify-between">
					<div class="w-[482px]">
						<p class="mb-6 text-[#5F5F5F] text-base leading-relaxed">
							You see, at Zenyx, we’ve always been ahead of the curve when it comes to work.
							From the get-go, we've embraced a virtually remote experience, connecting with
							top talents from every corner of the globe to work with some of the most interesting
						</p>
					</div>
					...
					<div class="flex items-center gap-4">
						<a href="#">
							<img src="/public/blog-detail/share.svg" alt="Share" class="w-5 h-5">
						</a>
						<a href="#">
							<img src="/public/blog-detail/icon1.svg" alt="Icon" class="w-5 h-5">
						</a>
					</div>
				</div>
			...
			<div class=" overflow-hidden mb-10 mt-5">
				<img src="/public/blog-detail/blog-post1.jpg" class="w-full object-cover" alt="">
			</div>
			...
			<div class=" overflow-hidden mb-10 mt-5">
				<img src="/public/blog-detail/blog-post2.jpg" class="w-full object-cover" alt="">
			</div>
			...
			<div class="max-w-3xl mx-auto">
				...
				<div class="flex items-center gap-4">
					...
					<a href="#">
						<img src="/public/blog-detail/X-icon.svg" alt="Share" class="w-5 h-5">
					</a>
					<a href="#">
						<img src="/public/blog-detail/linkedin.svg" alt="Icon" class="w-5 h-5">
					</a>
					<a href="#">
						<img src="/public/blog-detail/facebook.svg" alt="Icon" class="w-5 h-5">
					</a>
				</div>
			</div>
		</div>
		...
		<div class="container mx-auto">
			...
			<div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
				...
				<div class="rounded-2xl overflow-hidden border border-gray-200 bg-white relative">
					<img src="/public/Blog/blog-post1.jpg" class="w-full object-cover" alt="">
					<div class="p-6">
						...
						<a href="#" class="text-sm inline-flex items-center gap-2">
							Read More <img src="/public/Blog/Read-arrow.svg" alt="">
						</a>
					</div>
				</div>
				...
				<!-- Blog Card -->
				<div class="rounded-2xl overflow-hidden border border-gray-200 bg-white relative">
					<img src="/public/Blog/blog-post2.jpg" class="w-full object-cover" alt="">
					<div class="p-6">
						<span class="py-6">15 May 2024</span>
						<p class="mb-6">
							The power of secure system for access management
				...
				<!-- Blog Card -->
				<div class="rounded-2xl overflow-hidden border border-gray-200 bg-white relative">
					<img src="/public/Blog/blog-post3.jpg" class="w-full object-cover" alt="">
					<div class="p-6">
						<span class="py-6">15 May 2024</span>
						<p class="mb-6">
